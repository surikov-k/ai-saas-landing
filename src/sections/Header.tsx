  ...
  return (
    <>
                ...
                {navItems.map(({ name, href }) => (
                  <a
                    ...
                    className={`
                      ...
                      last:after:absolute last:after:bottom-0 last:after:left-0
                      last:after:h-2 last:after:w-px last:after:bg-gray-200/20
                    `}
                  >
                    {name}
                  </a>
              ...
              >
                ...
                >
                  <div
                    className={twMerge(
                      `
                        h-0.5 w-4 -translate-y-1 bg-gray-100 transition
                        duration-300
                      `,
      ...
      {isMobileNavOpen && (
        <div
          className={`
            fixed bottom-0 left-0 right-0 top-18 z-30 overflow-hidden
            bg-gray-950
          `}
        >
